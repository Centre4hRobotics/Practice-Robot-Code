...
<<<<<<< HEAD
  ...
  public static class MotorConstants {
    ...
    public static final AngularAcceleration maxAngularSlewRate = Units.RotationsPerSecondPerSecond.of(1);
    ...
    public static final AngularVelocity maxDrivingAngularVelocity = Units.RevolutionsPerSecond.of(1);
