...
<<<<<<< HEAD
        ...
        for(int i = 0; i<ids.length; i++) {
            velPubList[i] = nt.getTable(name).getDoubleTopic("Motor ID: " + ids[i] + ", Angular Velocity").publish();
    ...
    public void setNameList(String[] names, int[] ids) throws Exception {
        if(names.length!=ids.length)
            throw new Exception("Name List Must Be of Same Length as ID List");
...
<<<<<<< HEAD
        ...
        public String toString() {
            return "FlexyController, CAN ID: " + getDeviceID() + ", type: " + getType().name();
        }
=======
=======
  private TriMap<Integer, String, FlexyBrushlessController> map = new TriMap<>();
...
<<<<<<< HEAD
    public class TriMap<T1, T2, T3> {
        ...
        public T1 getT1FromT2(T2 t2) throws Exception {
            if(!contains(t2))
                throw new Exception("TriMap Does Not Contain: " + t2.toString());
            return hash21.get(t2);
        }

        public T1 getT1FromT3(T3 t3) throws Exception {
            if(!contains(t3))
                throw new Exception("TriMap Does Not Contain: " + t3.toString());
            return hash31.get(t3);
        }

        public T2 getT2FromT1(T1 t1) throws Exception {
            if(!contains(t1))
                throw new Exception("TriMap Does Not Contain: " + t1.toString());
            return hash12.get(t1);
        }

        public T2 getT2FromT3(T3 t3) throws Exception {
            if(!contains(t3))
                throw new Exception("TriMap Does Not Contain: " + t3.toString());
            return hash32.get(t3);
        }

        public T3 getT3FromT1(T1 t1) throws Exception {
            if(!contains(t1))
                throw new Exception("TriMap Does Not Contain: " + t1.toString());
            return hash13.get(t1);
        }

        public T3 getT3FromT2(T2 t2) throws Exception {
            if(!contains(t2))
                throw new Exception("TriMap Does Not Contain: " + t2.toString());
            return hash23.get(t2);
        }

        public HashMap<T1, T2> getHashT1T2() {
            return hash12;
        }

        public HashMap<T2, T1> getHashT2T1() {
            return hash21;
        }

        public HashMap<T2, T3> getHashT2T3() {
            return hash23;
        }

        public HashMap<T3, T2> getHashT3T2() {
            return hash32;
        }

        public HashMap<T1, T3> getHashT1T3() {
            return hash13;
        }

        public HashMap<T3, T1> getHashT3T1() {
            return hash31;
        }
