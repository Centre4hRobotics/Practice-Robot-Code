...
public class DriveWithJoystick extends Command {
    ...
    public void execute() {
        ...
        drive.drive(MotorConstants.maxDrivingVelocity.times(temp.getNorm()),
                temp.getAngle().getMeasure(),
                MotorConstants.maxDrivingAngularVelocity.times(controller.getRightX()),
